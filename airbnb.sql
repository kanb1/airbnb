...
DELETE FROM users WHERE user_pk = "1f4b8f74-8bac-49f8-bac6-ea0711506d14";
UPDATE users SET user_is_deleted = 0 WHERE user_pk = "ac7e58a6-b4e0-410b-af22-1fd106bbc6a5";	
